...
define('SECRET_SALT','b19052451f944aab5fd7f594048deae2');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','venkatanaveen.a@gmail.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','182.50.133.90');
define('DBNAME','Dpiind_osticket');
define('DBUSER','Dpiindosticket');
define('DBPASS','Dpiind1@3');
#Table prefix
define('TABLE_PREFIX','Dpiind');
